...
public class ConceptoLaboralControllerTest {
    ...
    public void testGetConceptosLaboralesById() throws Exception {
        ...
        when(conceptoLaboralService.getConceptosLaborales(1L, null)).thenReturn(Arrays.asList(conceptoLaboralDTO1));
    ...
    public void testGetConceptosLaboralesByIdAndNombre() throws Exception {
        ...
        when(conceptoLaboralService.getConceptosLaborales(1L, "Concepto 1")).thenReturn(Arrays.asList(conceptoLaboralDTO1));
